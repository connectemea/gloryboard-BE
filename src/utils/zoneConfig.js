  ...
  switch (zone?.toLowerCase()) {
    case 'a':
      return {
        ...
        participantCardImagePath: './src/templates/zone_a_participant_card.png',
        participantCardColor: rgb(0.843, 0.086, 0.184),
    ...
    case 'd':
      return {
        name:"D zone",
        primaryColor: rgb(0.26, 0.57, 0.26),
        headerImagePath: './src/templates/zone_d_participant_ticket_header.png',
        participantCardImagePath: './src/templates/zone_c_participant_card.png',
        participantCardColor: rgb(0.353, 0.231, 0.102),
        footerText: ["Kindly submit the D-zone copy along with the following documents to the Program Office on or before 28th January.", "A copy of your SSLC Book.", "A copy of your Hall Ticket."],
        DB_NAME: "D-Zone",
        idPrefix : "KPM"
      };
    case 'f':
